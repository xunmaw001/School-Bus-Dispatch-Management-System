...
public class JiashiyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiashiyuanEntity u = jiashiyuanService.selectOne(new EntityWrapper<JiashiyuanEntity>().eq("jiashiyuangonghao", username));
    ...
    public R register(@RequestBody JiashiyuanEntity jiashiyuan){
    	...
    	JiashiyuanEntity u = jiashiyuanService.selectOne(new EntityWrapper<JiashiyuanEntity>().eq("jiashiyuangonghao", jiashiyuan.getJiashiyuangonghao()));
		if(u!=null) {
